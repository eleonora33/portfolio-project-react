            ...
            <div className="row">
                ...
                <div className="col-lg-6 col-xm-12">
                    ...
                    <p>
                        ...
                        In her journey as a Full-Stack Web Developer, Eleonora is mastering HTML, CSS, Bootstrap, C#, .NET Core, ASP.NET MVC, ASP.NET Web API, Git, and React. Her dedication to growth, coupled with her passion for technology and creativity, fuels her mission to redefine digital experiences.
